function aboutData() {
    return [
        {
            section: 'About',
            text: `<p>OExperience in front-end development using HTML/HTML5, CSS/CSS3, JavaScript, TypeScript, React, React Router, Redux, jQuery, Express, Node.js, JSON, XML, and various other web development tools to build cutting-edge web applications.</p>
            <br>
        ...
        },
        {
            ...
            <div class="exper">
                ...
                <li>PayPal: Software engineer for i18n globalization team. Experience with Javascript, Node, Git, Agile.</li>
